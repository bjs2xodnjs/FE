...
console.log("myArray['2']", typeof myArray);
...
// console.log('myArray.5', myArray.5); 숫자 속성은 . 으로 불가 대괄호로만 가능!!

// 배열에 아이템 추가시 push메소드를 활용한다.
const myArray2 = [];
console.log('myArray2.length',myArray2.length); // 0이 찍힘
myArray2.push('안녕');
myArray2.push(3.14);
myArray2.push(true);
myArray2.push(false);
...
const pop = myArray2.pop(); // pop 은 마지막 요소 제거, 파괴 메소드
// cnsole.log('pop', pop);
console.log('myArray2', myArray2);
console.log('myArray2.length', myArray2.length);
